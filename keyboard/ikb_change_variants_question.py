...
def ikb_change_variants_question_quiz():
    btn1 = InlineKeyboardButton(text="➕Добавить вариант", callback_data="ikb_add_new_variant_quiz")
    btn2 = InlineKeyboardButton(text="🗑️Удалить", callback_data="ikb_delete_one_var_quiz")
    btn3 = InlineKeyboardButton(text="🗑️Удалить все", callback_data="ikb_clear_all_vars_quiz")
    btn4 = InlineKeyboardButton(text="↩️Назад", callback_data="ikb_back_settings_quest_quiz")
    builder = InlineKeyboardMarkup(inline_keyboard=[[btn1], [btn2], [btn3], [btn4]])
    return builder