...
def ikb_timer():
    ...
    btn8 = InlineKeyboardButton(text="1 день", callback_data=cb8)
    cb9 = Choose_timeer(cb="ikb_time", id="2d").pack()
    btn9 = InlineKeyboardButton(text="2 дня", callback_data=cb9)
    cb10 = Choose_timeer(cb="ikb_time", id="5d").pack()
    btn10 = InlineKeyboardButton(text="5 дней", callback_data=cb10)
    cb11 = Choose_timeer(cb="ikb_time", id="7d").pack()
    btn11 = InlineKeyboardButton(text="7 дней", callback_data=cb11)
