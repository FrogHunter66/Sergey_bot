...
async def main():
    ...
    try:
        ...
        dp.include_routers(create_event.router, utils.router, create_test.router, first.router, commands_for_tests.router, second.router, reuild_question.router, register.router, passing_test.router, buy_admin.router)
